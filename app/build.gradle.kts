...
dependencies {
    ...
    implementation(libs.wechat.qrcode.arm64)
    implementation(libs.wechat.qrcode.armv7)
    implementation(libs.wechat.qrcode.x8664)
    implementation(libs.wechat.qrcode.detector)
