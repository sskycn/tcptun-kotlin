...
Open Diagnostics and refresh once. Health checks are event/pull driven; there is no permanent
background health poll. Inspect the underlying network, core state, outbound health, and the
