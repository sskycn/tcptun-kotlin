...
- Optional traffic analysis for viewing TCP/UDP destinations from a selected app and generating routing rules.
- VPN, network, Go-core, outbound-health, TCPing, runtime-log, and connection-recovery diagnostics.
- Chinese and English UI and VPN foreground-service notifications.
